...
class PitchAvailibilityTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('pitch_availibility')->insert([
          ...
          'pitch_id' => $pitch[array_rand($pitch)]->id, 'stage_no' => '1',
        	'stage_start_date' =>  Carbon::now()->format('Y-m-d'),
          'stage_start_time' => Carbon::now()->format('H:i:s'),
        	'stage_end_time' => Carbon::now()->format('H:i:s'),
          'stage_continue_date' => Carbon::now()->format('Y-m-d'),
        	'break_start_time' => Carbon::now()->format('H:i:s'),
          'break_end_time' => Carbon::now()->format('H:i:s'),
        	'stage_end_date' => Carbon::now()->format('Y-m-d'),
          'stage_capacity' => '3.00',
          ...
          'stage_continue_date' => Carbon::now()->format('Y-m-d'),
           ...
           'break_end_time' => Carbon::now()->format('H:i:s'),
        	'stage_end_date' => Carbon::now()->format('Y-m-d'),
          'stage_capacity' => '3.00', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],

        	['tournament_id' => $tournament[array_rand($tournament)]->id, 'pitch_id' => $pitch[array_rand($pitch)]->id, 'stage_no' => '1',
