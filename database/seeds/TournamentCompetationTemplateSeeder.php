...
class TournamentCompetationTemplateSeeder extends Seeder
{
    ...
    {   
        ...
        DB::table('tournament_competation_template')->insert([
        	['tournament_id' => array_rand($tournament), 'total_teams' => '6',  'group_name' => 'U1012345', 'min_matches' => '5', 'tournament_template_id' => array_rand($tournaments), 'total_match' => '19',
        	...
        	['tournament_id' => array_rand($tournament), 'total_teams' => '7', 'group_name' => 'U11', 'min_matches' => '5', 'tournament_template_id' => array_rand($tournaments), 'total_match' => '18',
            ...
            ['tournament_id' => array_rand($tournament), 'total_teams' => '9', 'group_name' => 'U11', 'min_matches' => '5', 'tournament_template_id' => array_rand($tournaments), 'total_match' => '18',
