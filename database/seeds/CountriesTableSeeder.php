...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('countries')->insert([
          ...
          [ 'name' => 'ENGLAND', 'country_code' => 'EN', 'country_flag' => 'gb-eng', 'logo' => '/assets/img/flags/GB Eng.png', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ...
          [ 'name' => 'NORTHERN IRELAND', 'country_code' => 'NI', 'country_flag' => 'gb', 'logo' => '/assets/img/flags/GB Nir.png', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ...
          [ 'name' => 'SCOTLAND', 'country_code' => 'SC', 'country_flag' => 'gb-sct', 'logo' => '/assets/img/flags/GB Sct.png', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ...
          [ 'name' => 'WALES', 'country_code' => 'WA', 'country_flag' => 'gb-wls', 'logo' => '/assets/img/flags/GB Wls.png', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
