...
class CountriesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('countries')->insert([
          ...
          [ 'name' => 'ENGLAND', 'country_code' => 'EN', 'country_flag' => 'gb-eng', 'logo' => '/assets/img/flags/england.gif', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ...
          [ 'name' => 'NORTHERN IRELAND', 'country_code' => 'NI', 'country_flag' => 'gb', 'logo' => '/assets/img/flags/northern_ireland.gif', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ...
          [ 'name' => 'SCOTLAND', 'country_code' => 'SC', 'country_flag' => 'gb-sct', 'logo' => '/assets/img/flags/scotland.gif', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          ...
          [ 'name' => 'WALES', 'country_code' => 'WA', 'country_flag' => 'gb-wls', 'logo' => '/assets/img/flags/wales.gif', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          [ 'name' => 'ARGENTINA', 'country_code' => 'AR', 'country_flag' => 'ar', 'logo' => '/assets/img/flags/4x3/ar.svg', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          [ 'name' => 'BRAZIL', 'country_code' => 'BR', 'country_flag' => 'br', 'logo' => '/assets/img/flags/4x3/br.svg', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          [ 'name' => 'ALGERIA', 'country_code' => 'DZ', 'country_flag' => 'dz', 'logo' => '/assets/img/flags/4x3/dz.svg', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
          [ 'name' => 'GEORGIA', 'country_code' => 'GE', 'country_flag' => 'ge', 'logo' => '/assets/img/flags/4x3/ge.svg', 'created_at' => Carbon::now()->format('Y-m-d H:i:s')],
        ]);
    }
}
