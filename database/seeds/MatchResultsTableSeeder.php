...
class MatchResultsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $matchName = array('Awarded Away Win', 'Awarded Draw', 'Awarded Home Win', 'Home Win on Penalties', 'Away Win on Penalties', 'Postponed', 'Abandoned', 'Void', 'Temporary'); 
        $matchStatus = array('Walk over','abandoned','full-time','penalties');
