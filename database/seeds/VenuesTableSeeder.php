...
class VenuesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('venues')->insert([
        	['tournament_id' => $tournament[array_rand($tournament)]->id, 'name' => 'Sportpark Heimstetten', 'address1' => 'Am Sportpark 2', 
        	...
        	['tournament_id' => $tournament[array_rand($tournament)]->id, 'name' => 'RC Hades', 'address1' => 'Tulpinstraat 81',
        	...
        	['tournament_id' => $tournament[array_rand($tournament)]->id, 'name' => 'Atrest', 'address1' => 'test3',
