...
-(void)getGroupTeamList{
    ...
    if([Utils isNetworkAvailable] ==YES){
        ...
        NSDictionary *params = @{@"tournament_id":[app.defaultTournamentDir valueForKey:@"tournament_id"],@"group_id":[groupDir valueForKey:@"id"] };
        ...
        NSString *url=[[NSString alloc]initWithFormat:@"%@%@", BaseURL,GetGroupTeam];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    myVC.teamDetails = [_groupTeamArray objectAtIndex:indexPath.row];
