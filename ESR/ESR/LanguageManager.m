...
static NSString * const LanguageCodes[] = { @"en",@"fr", @"it", @"de", @"nl",@"cs",@"da", @"pl"};
static NSString * const LanguageStrings[] = { @"English",@"French", @"Italian", @"German", @"Dutch",@"Czech",@"Danish",@"Polish" };
