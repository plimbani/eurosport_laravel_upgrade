...
#import "AgeCategoryFinalPlacingVC.h"
#import "AgeGroupVC.h"
#import "Utils.h"
#import "Reachability.h"
#import "FinalPlacingVC.h"

@interface AgeCategoryFinalPlacingVC ()

@end

@implementation AgeCategoryFinalPlacingVC
-(void)getAgeList{
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"FinalPlacing" bundle:nil];
    FinalPlacingVC *myVC = (FinalPlacingVC *)[storyboard instantiateViewControllerWithIdentifier:@"FinalPlacingVC"];
    myVC.finalPlacingDir = [_agelistArray  objectAtIndex:indexPath.row];
