...
struct Storyboards {
    ...
    struct Teams: Storyboard {
        ...
        static func instantiateAllMatchesVC() -> AllMatchesVC {
            return self.storyboard.instantiateViewController(withIdentifier: kViewController.AllMatchesVC) as! AllMatchesVC
        }
    }
