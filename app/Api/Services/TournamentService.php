...
class TournamentService implements TournamentContract
{
    ...
    */
    ...
    public function templates($data = [])
    {
        ...
        if ($data1) {
            ...
            foreach ($data1 as $key => $value) {
                ...
                [$totalTime, $totalmatch, $dispFormatname, $template_font_color, $remark,
    ...
    private function calculateTime($data, $jsonData)
    {
        ...
        return [$total_time, $total_matches, $disp_format_name, $template_font_color, $remark, $avg_game_team];
    }
        ...
        if (isset($data['report_download']) && $data['report_download'] == 'yes') {
            foreach ($reportData as $reportRec) {
                ...
                if ($reportRec->homeTeam == '0') {
                    ...
                    } elseif (strpos($reportRec->competition_actual_name, 'Pos') !== false) {
