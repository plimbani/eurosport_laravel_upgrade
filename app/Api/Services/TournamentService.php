          ...
          if(isset($data['report_download']) &&  $data['report_download'] == 'yes') {
            foreach ($reportData as $reportRec) {
              ...
              $ddata = [
                ...
                $refName,
                ($reportRec->homeTeam == '0' && $reportRec->homeTeamName == '@^^@') ? 'Group-'. $reportRec->homePlaceholder : 
                $reportRec->homeTeam,
                ($reportRec->awayTeam == '0' && $reportRec->awayTeamName == '@^^@') ? 'Group-'. $reportRec->awayPlaceholder : 
                $reportRec->awayTeam,
              ];
