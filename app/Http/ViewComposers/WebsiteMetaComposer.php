...
class WebsiteMetaComposer
{
  ...
  public function compose(View $view)
  {
    ...
    $metaDetails = [];
    $organiserList = '';
    $organisers = $website->organisers()->pluck('name');
    ...
    $metaDetails['title'] = $website->tournament_name;
    ...
    $metaDetails['description'] = $website->tournament_name .', '. $website->tournament_location .' - ' .$website->tournament_dates .' '.'is organised by' .' '. $organiserList;
