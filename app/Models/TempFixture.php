...
class TempFixture extends Model
{
    ...
    'home_team','away_team_name', 'away_team', 'comments', 'match_winner', 'match_status','hometeam_score','awayteam_score','hometeam_point','awayteam_point','match_result_id','bracket_json','updated_at','deleted_at'];
