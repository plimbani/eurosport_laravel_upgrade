...
class Competition extends Model
{
    ...
    protected $fillable = ['id', 'tournament_id','tournament_competation_template_id','name', 'display_name', 'actual_name','team_size','competation_type','actual_competition_type', 'competation_round_no','created_at','updated_at','deleted_at','age_category_division_id'];
