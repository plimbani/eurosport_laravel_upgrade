...
class TournamentCompetationTemplates extends Model
{
    ...
    protected $fillable = ['id', 'tournament_id','total_match','total_time','disp_format_name','group_name','tournament_template_id','game_duration_RR','game_duration_FM','halftime_break_RR','halftime_break_FM','match_interval_RR','match_interval_FM','total_teams','min_matches','category_age','category_age_color','category_age_font_color','team_interval'];
