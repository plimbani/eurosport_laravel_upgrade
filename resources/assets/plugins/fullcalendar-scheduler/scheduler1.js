...
TimelineGrid = (function(superClass) {
  ...
  TimelineGrid.prototype.fgSegHtml = function(seg, disableResizing) {
    ...
    return '<a data-placement="top" data-toggle="tooltip" title="Hooray!" class="' + classes.join(' ') + '" style="' + cssToStr(this.getSegSkinCss(seg)) + '"' + (event.url ? ' href="' + htmlEscape(event.url) + '"' : '') + '>' +
