...
export default {
    ...
    components: {
        SummaryTab, ContactDetailsTab, SportsParksDetailsTab, SummaryReport, Messages, PresentationSettings, AddMessageModel, UnsaveMatchScoreModel,PublishTournament, UnPublishedTournament, TournamentStatus, PreviewTournament, DeleteModal
    },
