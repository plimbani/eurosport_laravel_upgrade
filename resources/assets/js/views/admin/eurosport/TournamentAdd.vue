...
<div class="card">
  <div class="card-block">
      <h6><strong>{{$lang.tournament_information}}</strong>
        <span v-if="this.currentLayout == 'commercialisation' && tournament.access_code != '' && tournament.access_code != null"  class="float-right font-weight-bold">{{ $lang.tournament_license_access_code}} #{{ tournament.access_code }}</span>
      </h6>
