            ...
            <div class="col-lg-12 col-xl-12 mt-2">
                <div class="card with-tabs">
                    <div class="card-header">
                        <div class="caption">
                            <h6><i class="fas fa-bar-chart text-success"></i> Total Expenses</h6>
                        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-6 mt-2">
                <div class="card">
                    <div class="card-header">
                        <div class="caption">
                            <h6><i class="fas fa-credit-card text-primary"></i> Summary</h6>
                        </div>
                        <div class="actions">
            ...
            <div class="col-lg-12 col-xl-6 mt-2">
                <div class="card">
                    <div class="card-header">
                        <div class="caption">
                            <h6><i class="fas fa-shopping-cart text-danger"></i> Total Revenue</h6>
                        </div>
                        <div class="actions">
