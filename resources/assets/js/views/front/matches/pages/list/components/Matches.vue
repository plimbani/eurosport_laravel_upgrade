          ...
          <tbody>
            <tr v-for="match in getMatchList()">
              ...
              <td>
                ...
                <div style="width: 20px;" v-if="match.HomeTeamShortsColor && match.HomeTeamShirtColor">
              ...
              <td>
                ...
                <div style="width: 20px;" v-if="match.AwayTeamShortsColor && match.AwayTeamShirtColor">
