...
export default {
  ...
  methods: {
    ...
    initialState() {
      return {
          ageCategory_name:'',category_age:'',category_age_color:null,game_duration_RR:'10',halves_RR:'2',game_duration_FM:'10',halves_FM:'2',halftime_break_RR:'5',halftime_break_FM:'5',match_interval_RR:'5',match_interval_FM:'5',tournamentTemplate:[],tournament_id: '', competation_format_id:'0',id:'',nwTemplate:[],game_duration_RR_other:'20',game_duration_FM_other:'20',match_interval_RR_other:'20',match_interval_FM_other:'20',min_matches:'',team_interval:'40'
      }
    },
    setEdit(id) {
