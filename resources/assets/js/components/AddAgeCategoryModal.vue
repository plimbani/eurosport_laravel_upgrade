<template>
  <div>
    <div class="modal fade" id="AgeCategoryModal" tabindex="-1" role="dialog" aria-labelledby="AgeCategoryModalLabel" style="display: none;" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="AgeCategoryModalLabel">{{$lang.competation_modal_age_category}}</h5>
            <button type="button" class="close" @click="closeAgeCategoryModal()">
