              ...
              <div class="col-md-6">
                <div class="jumbotron h-100 mb-0 px-4 py-4">
                  ...
                  <p class="row mb-0">
                      ...
                      <label class="col-md-4">{{templateData.tournament_teams}} teams<br/> {{templateData.competition_group_round}} <br/> {{templateData.competition_round}}</label>
                  </p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="jumbotron mb-0 h-100 px-4 py-4 m-h-214">
                  <p class="row">
                      <label class="col-md-8"><strong>{{$lang.competation_modal_matches_total_matches}}</strong></label>
                      <label class="col-md-4">{{ templateData['total_matches'] }}</label>
                  </p>
                  <p class="row">
                      <label class="col-md-8"><strong>{{$lang.competation_modal_time}}</strong></label>
                      <label class="col-md-4">{{totalTime | formatTime}} </label>
                  </p>
                   <p class="row">
                      <label class="col-md-8"><strong>{{$lang.competation_modal_remark}}</strong></label>
                  ...
                  <p class="row">
                    <label class="col-md-8"><strong>{{$lang.competation_modal_avg_games_team}}</strong></label>
                    <label class="col-md-4">
