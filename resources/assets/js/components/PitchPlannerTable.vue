                        ...
                        <ul class="nav nav-tabs nav-justified" role="tablist">
                            <li class="nav-item">
                                ...
                                <div class="wrapper-tab" v-if="currentLayout === 'commercialisation'">Matches 
                                        ...
                                        <span class="text-primary js-basic-popover" data-toggle="popover" data-animation="false" data-placement="left" data-content="Matches to be planned. Time is including breaks."><i class="fas fa-info-circle text-white"></i></span>
                                    </div>
