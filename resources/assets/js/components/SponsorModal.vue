      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row" :class="{'has-error': errors.has('logo') }">
            <div class="col-sm-5 form-control-label">{{ $lang.website_sponsor_logo }}*</div>
            <div class="col-sm-6">
          ...
          <div class="form-group row" :class="{'has-error': errors.has('name') }">
            <div class="col-sm-5 form-control-label">{{ $lang.website_sponsor_name }}*</div>
            <div class="col-sm-6">
          ...
          <div class="form-group row" :class="{'has-error': errors.has('name') }">
            <div class="col-sm-5 form-control-label">{{ $lang.website_sponsor_website }}*</div>
            <div class="col-sm-6">
