      ...
      <tr v-for="(match,index1) in getMatchList()">
        ...
        <td align="right">
          <!-- <a class="text-center text-primary" href="" @click.prevent="changeTeam(match.Home_id, match.HomeTeam)"> -->
            ...
            <span class="text-center" v-else><a class="text-primary" href="" @click.prevent="changeTeam(match.Home_id, match.HomeTeam)">{{ match.HomeTeam }}</a></span>
        ...
        <td align="left">
          ...
          <span class="text-center" v-else><a class="text-primary" href="" @click.prevent="changeTeam(match.Away_id, match.AwayTeam)">{{ match.AwayTeam }}</a></span>
          <!-- </a>  -->
        </td>
