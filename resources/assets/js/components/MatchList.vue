      ...
      <tr v-for="(match,index1) in getMatchList()">
        ...
        <td class="text-center js-match-list">
            <div class="d-inline-flex position-relative">
              ...
              <span class="circle-badge left" v-if="(match.isResultOverride == '1' && match.match_status == 'Walk-over' && match.match_winner == match.Home_id)"><i class="fa fa-asterisk" aria-hidden="true"></i></span>
            </div> -
            <div class="d-inline-flex position-relative" v-if="isUserDataExist && getCurrentScheduleView != 'teamDetails'">
              ...
              <span class="circle-badge right" v-if="(match.isResultOverride == '1' && match.match_status == 'Walk-over' &&match.match_winner == match.Away_id)"><i class="fa fa-asterisk" aria-hidden="true"></i></span>
            </div>
