                ...
                <div class="modal-body text-left">
                    ...
                    <div v-if="canDuplicateFavourites">
                        ...
                        <div class="c-input mt-3">
                            <input id="switch_default_tournament_in_preview" type="checkbox" class="euro-checkbox" v-model="switch_default_tournament" :true-value="1" :false-value="0" />
                            <label for="switch_default_tournament_in_preview">Please check the box if you would also like to switch the default tournament of users from the original tournament to this duplicated one.</label>
                        </div>
                    </div>
                </div>
