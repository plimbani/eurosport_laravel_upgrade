      ...
      <div class="modal-content">
          ...
          <div class="modal-body" id="pitch_model_body">
            <div class="form-group row mb-0">
              ...
              <label class="col-sm-3"></label><p class="col-sm-9">Team 1 ({{ (matchDetail.home_team == 0 && matchDetail.home_team_name == '@^^@') ? 'Group-'+matchDetail.home_team_placeholder_name : matchDetail.home_team_name }}) and Team 2 ({{ (matchDetail.away_team == 0 && matchDetail.away_team_name == '@^^@') ? 'Group-'+matchDetail.away_team_placeholder_name : matchDetail.away_team_name }}) </p>
            ...
            <form name="pitchModal">
              <div class="form-group row">
                ...
                <div class="col-sm-6 align-self-center">
                  Team 1 ({{ (matchDetail.home_team == 0 && matchDetail.home_team_name == '@^^@') ? 'Group-'+matchDetail.home_team_placeholder_name : matchDetail.home_team_name}})
                </div>
                <div class="col-sm-3 align-self-center">
                ...
                <div class="col-sm-6 align-self-center">
                  Team 2 ({{ (matchDetail.away_team == 0 && matchDetail.away_team_name == '@^^@') ? 'Group-'+matchDetail.away_team_placeholder_name : matchDetail.away_team_name }})
                </div>
                <div class="col-sm-3 align-self-center">
                ...
                <div class="col-sm-9">
                  <select name="match_winner" v-model="matchDetail.match_winner"
                   ...
                   id="match_winner" class="form-control ls-select2">
                      <option value="">Please select</option>
                      <option :value="matchDetail.home_team">Team 1 ({{ (matchDetail.home_team == 0 && matchDetail.home_team_name == '@^^@') ? 'Group-'+matchDetail.home_team_placeholder_name : matchDetail.home_team_name }})</option>
                      <option :value="matchDetail.away_team">Team 2 ({{ (matchDetail.away_team == 0 && matchDetail.away_team_name == '@^^@') ? 'Group-'+matchDetail.away_team_placeholder_name : matchDetail.away_team_name }})</option>
                  </select>
