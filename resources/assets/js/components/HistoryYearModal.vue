      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row" :class="{'has-error': errors.has('year') }">
            ...
            <div class="col-sm-6">
                <input v-model="formValues.year" v-validate="{'required':true, 'digits':4}" :class="{'is-danger': errors.has('year') }" name="year" type="text" class="form-control" :placeholder="$lang.year">
