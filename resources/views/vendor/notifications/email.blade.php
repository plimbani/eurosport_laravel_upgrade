  ...
  <div style="background-color:#eee;"><!--[if mso | IE]>
      ...
      @else
          <p>Hi {{$name}},
               ...
               <strong>Your Verification code: {{ $userOTP}}</strong><br/>
                <p>Here is a one-time verification code for use. <br />
                This code ensures that only you can access your account. </p>
