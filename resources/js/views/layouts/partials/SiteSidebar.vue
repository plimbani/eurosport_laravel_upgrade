        ...
        <div class="sidebar-body scroll-pane">
            <ul class="metismenu side-nav" id="menu">
                <li :class="{ active : isActive('/admin/dashboard') }">
                    <a href="#" aria-expanded="true"><i class="fas fa-dashboard"></i> Dashboard <span class="fas arrow fa-fw"></span></a>
                ...
                <li :class="{ active : isActive('/admin/layouts') }">
                    <a href="#" aria-expanded="true"><i class="fas fa-th-large"></i> Layouts <span class="fas arrow fa-fw"></span></a>
                    <ul aria-expanded="true">
                ...
                <li :class="{ active : isActive('/admin/basic-ui') }">
                    <a href="#" aria-expanded="true"><i class="fas fa-star"></i> Basic UI <span class="fas arrow fa-fw"></span></a>
                    <ul aria-expanded="true">
                ...
                <li :class="{ active: isActive('/admin/components') }">
                    <a href="#" aria-expanded="true"><i class="fas fa-puzzle-piece"></i> Components <span class="fas arrow fa-fw"></span></a>
                    <ul aria-expanded="true">
                ...
                <li :class="{ active: isActive('/admin/forms') }">
                    <a href="#" aria-expanded="true"><i class="fas fa-rocket"></i> Forms <span class="fas arrow fa-fw"></span></a>
                    <ul aria-expanded="true">
                ...
                <!--<li :class="{ active: isActive('/admin/pages') }">-->
                    <!--<a href="#" aria-expanded="true"><i class="fas fa-th-large"></i> Pages <span class="fas arrow fa-fw"></span></a>-->
                    <!--<ul aria-expanded="true">-->
                ...
                <li :class="{ active: isActive('/admin/settings') }">
                    <router-link to="/admin/settings" tag="li"><a><i class="fas fa-cogs"></i> Settings </a></router-link>
                </li>
            </ul>
        </div>
    </div>
