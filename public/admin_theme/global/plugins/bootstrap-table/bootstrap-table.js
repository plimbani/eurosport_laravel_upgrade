...
(function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES.en = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('Showing %s to %s of %s entries', pageFrom, pageTo, totalRows);
        },
        formatDetailPagination: function (totalRows) {
            return sprintf('Showing %s entries', totalRows);
        },
    ...
    BootstrapTable.prototype.initPagination = function () {
        ...
        if (!this.options.onlyInfoPagination) {
            ...
            html.push('</div>',
                ...
                '<li class="page-pre"><a href="javascript:void(0)">' + this.options.paginationPreText + '</a></li>');//' + this.options.paginationPreText + '
            //'<li class=""><a href="javascript:void(0)">First</a></li>',
    ...
    BootstrapTable.prototype.onPageFirst = function (event) {
        this.options.pageNumber = 1;
        $("li.page-pre a").addClass('disabled');
        this.updatePagination(event);
    };
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        // console.log(this.options.totalRows);
        // show no records
        // if (!html.length) {
